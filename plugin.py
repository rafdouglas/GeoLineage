...
class GeoLineagePlugin:
    ...
    def _update_icon(self, enabled: bool) -> None:
        ...
        if self.toggle_action:
            ...
            if enabled:
                self.toggle_action.setText("GeoLineage is recording. Click to pause.")
                self.toggle_action.setToolTip("GeoLineage is currently recording. Click to pause.")
            else:
                self.toggle_action.setText("GeoLineage is currently not recording. Click to start recording.")
